  ...
  return (
    <footer>
      ...
      <div className="site-map">
        <h2 className="site-map-h2">SITE MAP</h2>
        <p>About Us</p>
        <p>Courses</p>
        <p>Events</p>
        <p>Blog</p>
      ...
      <div className="courses">
        <h2 className="courses-h2">COURSES</h2>
        <p>Marketing</p>
        <p>Management</p>
        <p>HR & Recruting</p>
        <p>Design</p>
      ...
      <div className="contacts">
        <h2 className="contacts-h2">CONTACT US</h2>
      ...
      <div className="sign-up">
        <h2 className="sign-up-h2">SIGN UP TO OUR NEWSLETTER</h2>
        <input
          type="text"
